...
(function ($) {
        ...
        if (_4.buttons) {
            ...
            for (var i = 0; i < _4.buttons.length; i++) {
                ...
                if (_c == "-") {
                    ...
                    $("<a href=\"javascript:void(0)\"></a>").appendTo(td).linkbutton($.extend(_c, {
                        plain: true
                    })).bind("click", eval(_c.handler ||
					function () { }));
                }
            }
        }
    ...
    function _12(_13, _14) {
        ...
        bb.first.add(bb.prev).linkbutton({
            disabled: (_15.pageNumber == 1)
        });
        bb.next.add(bb.last).linkbutton({
            disabled: (_15.pageNumber == _16)
        });
        _18(_13, _15.loading);
    };
    ...
    $.fn.pagination = function (_1c, _1d) {
        ...
        return this.each(function () {
            ...
            if (_1f) {
                ...
                _1e = $.extend({},
				$.fn.pagination.defaults, $.fn.pagination.parseOptions(this), _1c);
