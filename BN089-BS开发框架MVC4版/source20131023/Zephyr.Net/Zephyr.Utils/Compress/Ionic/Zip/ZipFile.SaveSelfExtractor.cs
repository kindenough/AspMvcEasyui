...
namespace Zephyr.Utils.Ionic.Zip
{
    ...
    public class SelfExtractorSaveOptions
    {
        ...
        /// </para>
        /// </remarks>
        public Zephyr.Utils.Ionic.Zip.ExtractExistingFileAction ExtractExistingFile
        {
            get;
            set;
        }
    ...
    partial class ZipFile
    {
        ...
        private static ExtractorSettings[] SettingsList = {
            new ExtractorSettings() {
                ...
                CopyThroughResources = new List<string>{
                    "Zephyr.Utils.Ionic.Zip.WinFormsSelfExtractorStub.resources",
                    "Zephyr.Utils.Ionic.Zip.Forms.PasswordDialog.resources",
                    "Zephyr.Utils.Ionic.Zip.Forms.ZipContentsDialog.resources"},
        ...
        //         "namespace Zephyr.Utils.Ionic.Zip { public partial class WinFormsSelfExtractorStub { partial void _SetDefaultExtractLocation() {" +
        ...
        private void _SaveSfxStub(string exeToGenerate, SelfExtractorSaveOptions options)
        {
            ...
            try
            {
                ...
                // get the Zephyr.Utils.Ionic.Zip assembly
                ...
                using (var csharp = new Microsoft.CSharp.CSharpCodeProvider())
                {
                    ...
                    // This is the list of referenced assemblies.  Zephyr.Utils.Ionic.Zip is
                    ...
                    using (ZipFile zip = ZipFile.Read(a2.GetManifestResourceStream("Zephyr.Utils.Ionic.Zip.Resources.ZippedResources.zip")))
                    {
                        ...
                        {
                            // Use the ico file that is embedded into the Zephyr.Utils.Ionic.Zip
                        ...
                        // add the Zephyr.Utils.Ionic.Utils.Zip DLL as an embedded resource
