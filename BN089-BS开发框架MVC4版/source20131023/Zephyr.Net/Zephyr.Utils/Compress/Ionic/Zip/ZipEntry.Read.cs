...
namespace Zephyr.Utils.Ionic.Zip
{
    public partial class ZipEntry
    {
        ...
        private static bool ReadHeader(ZipEntry ze, System.Text.Encoding defaultEncoding)
        {
            ...
            int signature = Zephyr.Utils.Ionic.Zip.SharedUtilities.ReadEntrySignature(ze.ArchiveStream);
            bytesRead += 4;
            ...
            if (ZipEntry.IsNotValidSig(signature))
            {
                ...
                // workitem 10178
                Zephyr.Utils.Ionic.Zip.SharedUtilities.Workaround_Ladybug318918(ze.ArchiveStream);
            ...
            ze._LastModified = Zephyr.Utils.Ionic.Zip.SharedUtilities.PackedToDateTime(ze._TimeBlob);
            ...
            if (!ze._FileNameInArchive.EndsWith("/") && (ze._BitField & 0x0008) == 0x0008)
            {
                ...
                while (wantMore)
                {
                    ...
                    long d = Zephyr.Utils.Ionic.Zip.SharedUtilities.FindSignature(ze.ArchiveStream, ZipConstants.ZipEntryDataDescriptorSignature);
                    if (d == -1) return false;
        ...
        private static void HandleUnexpectedDataDescriptor(ZipEntry entry)
        {
            ...
            {
                int sz = Zephyr.Utils.Ionic.Zip.SharedUtilities.ReadInt(s);
                if (sz == entry._CompressedSize)
                {
                    sz = Zephyr.Utils.Ionic.Zip.SharedUtilities.ReadInt(s);
