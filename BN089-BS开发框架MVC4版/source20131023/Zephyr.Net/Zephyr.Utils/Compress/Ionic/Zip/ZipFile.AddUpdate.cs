...
namespace Zephyr.Utils.Ionic.Zip
{
    public partial class ZipFile
    {
        ...
        /// </remarks>
        ///
        /// <seealso cref="Zephyr.Utils.Ionic.Zip.ZipFile.AddFile(string)"/>
        /// <seealso cref="Zephyr.Utils.Ionic.Zip.ZipFile.AddDirectory(string)"/>
        /// <seealso cref="Zephyr.Utils.Ionic.Zip.ZipFile.UpdateItem(string)"/>
        ///
        ...
        /// </param>
        ///
        /// <seealso cref="Zephyr.Utils.Ionic.Zip.ZipFile.AddFile(string, string)"/>
        /// <seealso cref="Zephyr.Utils.Ionic.Zip.ZipFile.AddDirectory(string, string)"/>
        /// <seealso cref="Zephyr.Utils.Ionic.Zip.ZipFile.UpdateItem(string, string)"/>
        ///
        /// <example>
        ...
        /// <overloads>This method has two overloads.</overloads>
        ///
        /// <seealso cref="Zephyr.Utils.Ionic.Zip.ZipFile.AddItem(string)"/>
        /// <seealso cref="Zephyr.Utils.Ionic.Zip.ZipFile.AddDirectory(string)"/>
        /// <seealso cref="Zephyr.Utils.Ionic.Zip.ZipFile.UpdateFile(string)"/>
        ///
        /// <param name="fileName">
        ...
        /// </example>
        ///
        /// <seealso cref="Zephyr.Utils.Ionic.Zip.ZipFile.AddItem(string,string)"/>
        /// <seealso cref="Zephyr.Utils.Ionic.Zip.ZipFile.AddDirectory(string, string)"/>
        /// <seealso cref="Zephyr.Utils.Ionic.Zip.ZipFile.UpdateFile(string,string)"/>
        ///
        /// <param name="fileName">
        ...
        /// </param>
        ///
        /// <seealso cref="Zephyr.Utils.Ionic.Zip.ZipFile.SelectEntries(String)" />
        ...
        /// </example>
        ///
        /// <seealso cref="Zephyr.Utils.Ionic.Zip.ZipFile.AddSelectedFiles(String, String)" />
        ...
        ///
        /// <seealso cref="Zephyr.Utils.Ionic.Zip.ZipFile.AddFile(string)"/>
        /// <seealso cref="Zephyr.Utils.Ionic.Zip.ZipFile.UpdateDirectory(string)"/>
        /// <seealso cref="Zephyr.Utils.Ionic.Zip.ZipFile.UpdateItem(string)"/>
        ///
        /// <param name="fileName">
        ...
        ///
        /// <seealso cref="Zephyr.Utils.Ionic.Zip.ZipFile.AddFile(string,string)"/>
        /// <seealso cref="Zephyr.Utils.Ionic.Zip.ZipFile.UpdateDirectory(string,string)"/>
        /// <seealso cref="Zephyr.Utils.Ionic.Zip.ZipFile.UpdateItem(string,string)"/>
        ///
        /// <param name="fileName">
        ///   The name of the file to add or update. It should refer to a file in the
        ...
        /// </example>
        ///
        /// <seealso cref="Zephyr.Utils.Ionic.Zip.ZipFile.UpdateEntry(string, System.IO.Stream)"/>
        ///
        /// <param name="entryName">
        ...
        ///
        /// using(Zephyr.Utils.Ionic.Zip.ZipFile zip = new Zephyr.Utils.Ionic.Zip.ZipFile())
        /// {
        ...
        /// <seealso cref="Zephyr.Utils.Ionic.Zip.ZipEntry.InputStream"/>
        ///
        /// <param name="entryName">
        ///   The name, including any path, to use within the archive for the entry.
        /// </param>
