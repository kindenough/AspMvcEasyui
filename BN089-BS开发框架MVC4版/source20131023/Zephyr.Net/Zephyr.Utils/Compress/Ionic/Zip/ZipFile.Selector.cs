...
namespace Zephyr.Utils.Ionic.Zip
{
    ...
    partial class ZipFile
    {
                                               ...
                                               bool wantUpdate)
        {
            ...
            Zephyr.Utils.Ionic.FileSelector ff = new Zephyr.Utils.Ionic.FileSelector(selectionCriteria,
...
namespace Zephyr.Utils.Ionic
{
    internal abstract partial class SelectionCriterion
    {
        internal abstract bool Evaluate(Zephyr.Utils.Ionic.Zip.ZipEntry entry);
    }


    internal partial class NameCriterion : SelectionCriterion
    {
        internal override bool Evaluate(Zephyr.Utils.Ionic.Zip.ZipEntry entry)
        {
    ...
    {
        private bool Evaluate(Zephyr.Utils.Ionic.Zip.ZipEntry entry)
        {
        ...
        public ICollection<Zephyr.Utils.Ionic.Zip.ZipEntry> SelectEntries(Zephyr.Utils.Ionic.Zip.ZipFile zip)
        {
            if (zip == null)
                throw new ArgumentNullException("zip");

            var list = new List<Zephyr.Utils.Ionic.Zip.ZipEntry>();

            foreach (Zephyr.Utils.Ionic.Zip.ZipEntry e in zip)
            {
                if (this.Evaluate(e))
                    list.Add(e);
            }
        ...
        ///
        /// <returns>a collection of ZipEntry objects that conform to the criteria.</returns>
        public ICollection<Zephyr.Utils.Ionic.Zip.ZipEntry> SelectEntries(Zephyr.Utils.Ionic.Zip.ZipFile zip, string directoryPathInArchive)
        {
            if (zip == null)
                throw new ArgumentNullException("zip");
