...
using Zephyr.Utils.ZipLib.Encryption;
#endif

using Zephyr.Utils.ZipLib.Core;
using Zephyr.Utils.ZipLib.Checksums;
using Zephyr.Utils.ZipLib.Zip.Compression.Streams;
using Zephyr.Utils.ZipLib.Zip.Compression;

namespace Zephyr.Utils.ZipLib.Zip 
{
	...
	public class ZipFile : IEnumerable, IDisposable
	{
		...
		/// </exception>
		/// <exception cref="Zephyr.Utils.ZipLib.Zip.ZipException">
