...
namespace Zephyr.Utils.EPPlus.Style
{
    /// <summary>
    /// Border line style
    /// </summary>
    ...
    public abstract class StyleBase
    {
        ...
        internal Zephyr.Utils.EPPlus.XmlHelper.ChangedEventHandler _ChangedEvent;
        protected int _positionID;
        protected string _address;
        internal StyleBase(ExcelStyles styles, Zephyr.Utils.EPPlus.XmlHelper.ChangedEventHandler ChangedEvent, int PositionID, string Address)
        {
            _styles = styles;
