...
using Zephyr.Utils.EPPlus.Utils;
using System.Xml;
using Zephyr.Utils.EPPlus.DataValidation.Contracts;

namespace Zephyr.Utils.EPPlus.DataValidation
{
    /// <summary>
    /// <para>
    ...
    public class ExcelDataValidationCollection : XmlHelper, IEnumerable<IExcelDataValidation>
    {
        ...
        public bool Remove(IExcelDataValidation item)
        {
            ...
            {
                throw new InvalidCastException("The supplied item must inherit Zephyr.Utils.EPPlus.DataValidation.ExcelDataValidation");
            }
